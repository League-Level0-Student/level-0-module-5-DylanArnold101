...
public class Code4Life {
	public static void main(String[] args) {
		String hc = JOptionPane.showInputDialog("How many hours have you spent coding this week? ");
		int coding = Integer.parseInt(hc);
		if (coding > 3) {
			JOptionPane.showMessageDialog(null, "You are a code Ninja!");
		}
if(coding<2) {JOptionPane.showMessageDialog(null, "Stop watching youtube");}
	
if(coding>5) {playBatmanTheme();}}
	/*
